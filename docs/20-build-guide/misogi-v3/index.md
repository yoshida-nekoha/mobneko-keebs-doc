...
`BLE Micro Pro`(以下 BMP と表記) を使った無線版で説明しています。  
電源パーツがない以外、ProMicro 版も組み立て方は一緒です。

※ v3.2の基盤QRコードから来た場合は [v3.2のビルドガイド](/docs/build-guide/misogi-v3.2)を参照してください
